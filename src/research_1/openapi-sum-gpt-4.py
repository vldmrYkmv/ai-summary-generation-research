...
def run_summarization(data):
  ...
  response = client.chat.completions.create(
    ...
    messages=[
      {"role": "system", "content": "You will be provided with a block of text, and your task is to return a short one sentence of what is happening in provided text."},
...
if __name__ == '__main__':
  try:
    ...
    run_algorithm_in_results(run_summarization, "openapi-sum-gpt-4")
