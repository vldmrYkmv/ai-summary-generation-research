...
# Based on https://github.com/akashp1712/nlp-akash/blob/master/text-summarization/TF_IDF_Summarization.py
...
if __name__ == '__main__':
  try:
    ...
    run_algorithm_in_results(run_summarization, "tf-idf-sum")
